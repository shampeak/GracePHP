## 框架说明
>Grace是一个轻型组件式PHP框架，尝试用优雅的代码编写，适用于简单系统的快速开发，提供了简单的路由方式，简单且实用。内置所有的组件都可以单独使用，并且附有测试代码和全文档,有很好的安全性，稳定性，扩展性,目前GracePHP由Shampeak组开发维护，如果你希望参与到此项目中来，可以到Github上Fork项目并提交Pull Request。
